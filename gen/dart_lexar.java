...
public class dart_lexar extends Lexer {
	...
	public static final int
		...
		COLON=12, PLUS=13, EQUAL=14, ASSIGN=15, NOTEQUAL=16, INT=17, STRING=18, 
		BOOL=19, LIST=20, EXTENDS=21, RETURN=22, STRING_LINE=23, BUILDCONTEXT=24, 
		STATE=25, CREATE=26, CREATESTATE=27, WIDGET=28, BUILD=29, CONTAINER=30, 
		EXPANDED=31, MATERIALBUTTON=32, CHILD=33, WIDTH=34, HEIGHT=35, COLOR=36, 
		MATERIALAPP=37, HOME=38, STATEFULL=39, STATELESS=40, TRUE=41, FALSE=42, 
		NAME=43, NUMBER=44, COMMENT=45, OVERRIDE=46, PRIVATE=47, WS=48;
