...
public class dart_parse extends Parser {
	...
	public static final int
		...
		WIDTH=51, HEIGHT=52, COLOR=53, MATERIALAPP=54, HOME=55, SCAFFOLD=56, PADDING=57, 
		PADDINGSMALL=58, EDGEINSETS=59, ROW=60, COLUMN=61, ONPRESSED=62, IMAGE=63, 
		BODY=64, TEXT=65, NETWORK=66, CHILDREN=67, DYNAMIC=68, STATEFULL=69, STATELESS=70, 
		TRUE=71, FALSE=72, NAME=73, NUMBERDOUBLE=74, NUMBER=75, COMMENT=76, OVERRIDE=77, 
		PRIVATE=78, WS=79, ELSEIF=80, ELSE=81;
	public static final int
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			"COMMENT", "OVERRIDE", "PRIVATE", "WS", "ELSEIF", "ELSE"
		};
	}
	...
	public final ClassDeclarationContext classDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la - 23)) & ~0x3f) == 0 && ((1L << (_la - 23)) & 1125899906850591L) != 0) {
				{
				{
				setState(135);
				dartVariabelsDeclaration();
	...
	public final OnPressedPropertyDeclarationContext onPressedPropertyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la - 23)) & ~0x3f) == 0 && ((1L << (_la - 23)) & 1125899906940703L) != 0) {
				{
				setState(539);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public final SetStatePressedDeclarationContext setStatePressedDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la - 23)) & ~0x3f) == 0 && ((1L << (_la - 23)) & 1125899906875167L) != 0) {
				{
				{
				setState(552);
				statement();
	...
	public final ChildrenPropertyDeclarationContext childrenPropertyDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la - 47)) & ~0x3f) == 0 && ((1L << (_la - 47)) & 353927L) != 0) {
				{
				setState(583);
				widgetsDeclaration();
				setState(588);
	...
	public final FunctionContext function() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la - 23)) & ~0x3f) == 0 && ((1L << (_la - 23)) & 1125899906850591L) != 0) {
				{
				setState(649);
				parameters();
				}
